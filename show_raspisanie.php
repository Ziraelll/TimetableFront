...
echo "<div><a href = 'show_raspisanie.php' class='button3'>Сброc&nbsp;фильтра</a></div>";
...
echo "' class='button2'><img class='inverted' src='image/calendar_prev.png'></a>";
//echo "' class='button2'><span>Предыдущая неделя</span></a>";

echo "<a  href = 'show_raspisanie.php?date=".$nextweek;
if (isset($_GET['name_group']))
    echo   "&name_group=".$_GET['name_group']; 
echo "' class='button'><img class='inverted' src='image/calendar_next.png'></a>";
...
//[Следующая неделя]
        ...
        if (mysqli_num_rows($result) > 0) {
                ...
                echo "<TABLE  cellpadding='5' align='center' border='1px' style='border-collapse: collapse;'>";
